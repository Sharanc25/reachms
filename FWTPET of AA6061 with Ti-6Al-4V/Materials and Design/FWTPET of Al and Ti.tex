...
\subsection{FWTPET}
\label{subsec:FWTPET}
FWTPET process was carried out in a 4-Axis Friction Stir Welding machine (\ref{fig:fsw-machine}). Before welding, the tube and the plate were cleaned with Acetone to remove dirt and grease. The tube and plate were fitted to a specially designed backing block as shown in \ref{fig:backing-block}. The samples were welded at 4 speeds : 560, 710, 1120 and 1200 rpm. The parameters that were kept constant for all the welds were plunge rate - 2 mm/min, plunge depth - 2 mm and tube projection - 2 mm.
